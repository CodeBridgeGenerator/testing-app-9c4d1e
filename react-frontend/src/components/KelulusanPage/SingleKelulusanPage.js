...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Pelulus</label><p className="m-0 ml-3" >{Number(_entity?.pelulus)}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-primary">Status</label><p className="m-0 ml-3" >{Number(_entity?.status)}</p></div>
