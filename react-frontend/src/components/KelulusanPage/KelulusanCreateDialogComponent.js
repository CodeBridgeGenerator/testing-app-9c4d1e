...
<div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                ...
                <InputNumber id="pelulus" className="w-full mb-3 p-inputtext-sm" value={_entity?.pelulus} onChange={(e) => setValByKey("pelulus", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field mt-5">
            <span className="align-items-center">
                ...
                <InputNumber id="status" className="w-full mb-3 p-inputtext-sm" value={_entity?.status} onChange={(e) => setValByKey("status", e.value)}  />
            </span>
            <small className="p-error">
