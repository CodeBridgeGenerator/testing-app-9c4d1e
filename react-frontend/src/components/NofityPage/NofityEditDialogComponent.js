...
pengajur: _entity?.pengajur,
        ...
        const result = await client.service("nofity").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info nofity updated successfully" });
    ...
    return (
        <Dialog header="Edit Nofity" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="nofity-edit-dialog-component">
