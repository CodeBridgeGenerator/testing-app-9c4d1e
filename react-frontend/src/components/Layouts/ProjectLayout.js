...
import NofityPage from "../NofityPage/NofityPage";
// ~cb-add-import~
...
<li
                onClick={() => {
                  setCurrentActiveTab2("nofity");
                }}
                className={classNames("mb-3 flex align-items-start p-3", {
                  "bg-yellow-700": props?.currentActiveTab2 === "nofity",
                })}
                style={{ borderRadius: "12px" }}
              >
                <i
                  className="pi pi-user text-xl mr-3 "
                  style={{ color: props?.currentActiveTab2 !== "nofity" ? "black" : "white" }}
                ></i>
                <div className="flex flex-column">
                  <span
                    className={classNames({
                      "text-white": props?.currentActiveTab2 === "nofity",
                      "text-black": props?.currentActiveTab2 !== "nofity",
                    })}
                  >
                  Nofity
                  </span>
                  <p
                    className={classNames("mt-2 mb-0 line-height-3 ", {
                      "text-yellow-500": props?.currentActiveTab2 === "nofity",
                      "text-yellow-700": props?.currentActiveTab2 !== "nofity",
                    })}
                  >
                    Accumsan sit amet nulla facilisi morbi tempus iaculis.
                  </p>
